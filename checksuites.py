...
def main():
  ...
  "u-bh336" : ["martinandrews" , "HadGEM3-GA7.1 N96 AMIP CMIP6 spinup # 1 : with ozone redistribution"] ,
  "u-bh337" : ["martinandrews" , "HadGEM3-GA7.1 N96 AMIP CMIP6 spinup # 2 : with ozone redistribution"] ,
  "u-bh338" : ["martinandrews" , "HadGEM3-GA7.1 N96 AMIP CMIP6 spinup # 3 : with ozone redistribution"] ,
  "u-bh339" : ["martinandrews" , "HadGEM3-GA7.1 N96 AMIP CMIP6 spinup # 4 : with ozone redistribution"] ,
  "u-bh432" : ["martinandrews" , "#Test. HadGEM3-GC3.1 N96ORCA1 HIST run CMIP6 member #1 : 1940+"] ,
